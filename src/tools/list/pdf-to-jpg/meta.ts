...
export const meta: ToolMeta = {
  ...
  category: 'pdf',
  keywords: ['pdf to jpg', 'convert pdf to image', 'extract pdf images', 'pdf to jpeg', 'convert pdf to jpg online', 'client side pdf to jpg'],
  icon: 'FileText',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'For presentations or graphic-heavy PDFs, 2x scale (High Quality) is recommended to keep texts legible.',
      'If you only need a single page, you can click "Download Page" directly on that page thumbnail to save time.'
    ]
  }
};
