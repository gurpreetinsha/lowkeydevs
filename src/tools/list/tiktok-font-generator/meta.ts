...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['tiktok font generator', 'tiktok bio fonts', 'tiktok captions font', 'cool fonts for tiktok', 'tiktok nickname fonts', 'font changer for tiktok'],
  icon: 'brush',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use small caps or bold sans-serif for your TikTok profile Name to make it prominent.',
      'In captions, use fancy fonts on keywords to catch attention in the first three seconds of a user scrolling their FYP.'
    ]
  }
};
