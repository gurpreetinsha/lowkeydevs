...
export const meta: ToolMeta = {
  ...
  category: 'image',
  keywords: ['image to text converter', 'ocr online', 'extract text from image', 'scan image to text', 'picture to text reader', 'privacy first ocr'],
  icon: 'image',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'For best results, crop out unnecessary margins or background elements before running OCR.',
      'Ensure the text is rotated upright for the optical character recognition model to align correctly.'
    ]
  }
};
