...
export const meta: ToolMeta = {
  ...
  category: 'image',
  keywords: ['image to ascii art', 'picture to text art', 'ascii generator', 'retro text art', 'convert photo to text code', 'ansi art generator'],
  icon: 'image',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'For best results, use high-contrast images with clean backgrounds (like logos or portrait silhouettes).',
      'If copying to platforms like Discord, wrap the text inside triple backticks (```) to enforce a monospace layout.'
    ]
  }
};
