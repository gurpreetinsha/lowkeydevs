...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['bold text generator', 'bold text copy paste', 'bold font converter', 'how to bold text', 'fb bold text', 'instagram bold generator', 'unicode bold'],
  icon: 'Type',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use Serif Bold for academic or editorial contexts, and Sans-Serif Bold for modern, clean visual headlines.',
      'Bold text in email subject lines can help increase open rates, but use it sparingly to avoid spam filters.'
    ]
  }
};
