...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['cute font generator', 'aesthetic fonts', 'cute text generator', 'kaomoji generator', 'sparkle fonts copy paste', 'hearts font generator'],
  icon: 'sparkles',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use the wing or heart symbols to frame your name in gaming or social media profiles (e.g., ʚ♡⃛ɞ Name ʚ♡⃛ɞ).',
      'Mix in Japanese kaomojis (like ✿◠‿◠) to express your mood alongside your styled text.'
    ]
  }
};
