...
export const meta: ToolMeta = {
  ...
  category: 'pdf',
  keywords: ['add watermark to pdf', 'pdf watermark creator', 'watermark pdf online', 'insert image watermark pdf', 'confidential stamp pdf', 'local pdf watermark'],
  icon: 'FileText',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'An opacity level of 0.2 to 0.3 is recommended to prevent the watermark from obstructing main text readability.',
      'Diagonal angles (-45 or -30 degrees) look the most professional for text stamps like "CONFIDENTIAL".'
    ]
  }
};
