...
export const meta: ToolMeta = {
  ...
  category: 'pdf',
  keywords: ['add page numbers', 'pdf page numbers', 'number pdf pages', 'insert page numbers pdf', 'local page numbering', 'client side pdf tool'],
  icon: 'FileText',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Standard footers use a 20-point margin from page boundaries. Increase this padding if the text overlaps with existing page contents.',
      'Use contrasting colors (e.g. black or dark blue) for visibility.'
    ]
  }
};
