...
export const meta: ToolMeta = {
  ...
  category: 'video',
  keywords: ['online video converter', 'video to mp3', 'video to mp4', 'mp4 to webm', 'video to gif converter', 'extract audio from video', 'client side video converter'],
  icon: 'video',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Extracting audio from long lectures is a great way to save space and listen on the go.',
      'Convert short video segments to GIF animations for easy sharing on social platforms.'
    ]
  }
};
