...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['whatsapp font generator', 'whatsapp bold text', 'whatsapp italic converter', 'whatsapp text styles', 'whatsapp font changer', 'cool whatsapp fonts'],
  icon: 'messagesquare',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Combine native bold and italics (e.g. *_text_*) for maximum emphasis in group chats.',
      'Use monospace text for sending clean tables, code, addresses, or alignment-sensitive text in chat.'
    ]
  }
};
