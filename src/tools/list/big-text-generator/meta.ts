...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['big text generator', 'ascii art generator', 'giant letters copy paste', 'large text generator', 'text banner maker', 'word art generator', 'block letters ascii'],
  icon: 'Terminal',
  faqs: [
    {
