...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['small text generator', 'tiny text', 'small caps generator', 'superscript generator', 'subscript generator', 'small letters copy paste', 'tiny font maker'],
  icon: 'Type',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Superscript is great for writing math exponents or footnote symbols in text messages: x³ + y².',
      'Small Caps are popular for branding, aesthetic descriptions, and clean layout subheadings on social profiles.'
    ]
  }
};
