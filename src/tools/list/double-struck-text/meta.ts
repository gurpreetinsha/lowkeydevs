...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['double struck text', 'blackboard bold generator', 'hollow letters', 'outline text generator', 'unicode outline font', 'math blackboard bold'],
  icon: 'sparkles',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use double-struck digits (e.g. 𝟘𝟙𝟚) to create stylish numbers in list headings.',
      'Combine blackboard bold symbols with standard serif text for elegant typography setups.'
    ]
  }
};
