...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['instagram fonts', 'instagram bio fonts', 'ig font generator', 'fancy text instagram', 'cool text for instagram', 'font changer for instagram', 'instagram caption generator'],
  icon: 'instagram',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Mix and match different font styles for your name and your bio description to create a clean hierarchy.',
      'Use bold serif or sans-serif for headings, cursive/script for details, and add aesthetic symbols or emojis to separate lines.'
    ]
  }
};
