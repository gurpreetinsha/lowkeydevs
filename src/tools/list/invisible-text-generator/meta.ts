...
export const meta: ToolMeta = {
  ...
  category: 'generators',
  keywords: ['invisible text', 'zero width space', 'invisible characters', 'hide message in text', 'invisible steganography', 'blank space copy', 'form bypass', 'hidden watermark'],
  icon: 'EyeOff',
  faqs: [
    {
