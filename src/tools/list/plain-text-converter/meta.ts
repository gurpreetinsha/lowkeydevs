...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['plain text converter', 'strip styling', 'remove rich text formatting', 'html to plain text', 'strip markdown', 'normalize mathematical unicode', 'de-format text'],
  icon: 'FileText',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use the "Normalize Unicode Symbols" feature to convert fancy social media fonts (often used on Twitter or LinkedIn profiles) into regular text.',
      'Check the "Trim Whitespace" options to remove double spaces and collapse consecutive blank lines.'
    ]
  }
};
