...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['discord font generator', 'discord markdown generator', 'discord colored text', 'discord text formatting', 'discord font changer', 'ansi color codes discord'],
  icon: 'messagesquare',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use ANSI color block generators to create eye-catching announcements, notices, and rules in your server.',
      'Use double-struck or cursive fonts for channel names to organize your Discord server categories in a clean, aesthetic layout.'
    ]
  }
};
