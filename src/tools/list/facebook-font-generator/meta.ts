...
export const meta: ToolMeta = {
  ...
  category: 'text',
  keywords: ['facebook font generator', 'facebook bold text', 'fb font changer', 'stylish text for facebook', 'copy paste facebook fonts', 'cool text fb'],
  icon: 'facebook',
  faqs: [
    {
  ...
  educationalContent: {
    ...
    proTips: [
      'Use bold sans-serif fonts for the first line of your posts to act as an eye-catching headline.',
      'Wrap important call-to-actions (like links or discount codes) in bubble or squared fonts to drive clicks.'
    ]
  }
};
